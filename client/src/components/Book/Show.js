                ...
                return (
                    <div className="container">
                        <div className="panel panel-default">
                            ...
                            <h4><Link to="/book">Book List</Link></h4>
                            ...
                            <div className="panel-body">
                                ...
                                <Mutation mutation={DELETE_BOOK} key={data.book._id} onCompleted={() => this.props.history.push('/book')}>
                                    {(removeBook, { loading, error }) => (
                                        <div>
                                            <form
                                                ...
                                                <Link to={`/book/edit/${data.book._id}`} className="btn btn-success">Edit</Link>&nbsp;
